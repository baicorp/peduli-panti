      ...
      <table className="table-auto min-w-full">
        <thead>
          <tr>
            ...
            <th className="px-4 py-2 bg-gray-200 text-center">Nama Donatur</th>
            <th className="px-4 py-2 bg-gray-200 text-center">Kontak</th>
            <th className="px-4 py-2 bg-gray-200 text-center">Jumlah Donasi</th>
            <th className="px-4 py-2 bg-gray-200 text-center">Bukti Transaksi</th>
          </tr>
        </thead>
        <tbody>
          <tr>
